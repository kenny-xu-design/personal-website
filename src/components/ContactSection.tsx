export default function ContactSection() {
  return (
    <section id="contact" className="relative flex min-h-screen overflow-hidden bg-contact-fallback py-28">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-portfolio flex-col justify-center px-5 sm:px-8 lg:px-12">
        <p className="mb-6 text-xs font-semibold uppercase tracking-[0.55em] text-ember-400">Contact</p>
        <h2 className="animate-soft-reveal max-w-6xl text-[clamp(3.8rem,8.5vw,10rem)] font-black uppercase leading-[0.86] text-white">
          LET&apos;S CREATE
          <span className="block">SOMETHING MEANINGFUL.</span>
        </h2>
        <p className="mt-8 max-w-2xl text-lg leading-9 text-white/[0.62]">
