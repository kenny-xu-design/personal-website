  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div
          className="relative min-h-0 flex-1 touch-pan-y overflow-hidden bg-[radial-gradient(circle_at_50%_35%,rgba(255,154,45,0.08),transparent_34rem),#030405] px-2 pb-2 pt-16 sm:px-3 sm:pb-3 md:px-8 md:pb-5 md:pt-20"
